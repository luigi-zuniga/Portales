...
<head>
	...
	<title>Ejemplares - Recomendaciones de Lectura</title>
    ...
    <!--[if lt IE 9]>
        <script src="https://oss.maxcdn.com/libs/h  tml5shiv/3.7.0/html5shiv.js"></script>
...
<body>
	...
	<header id="header-comite">
		<div class="container">
			<?php
				include("com_integrantes_header.php");
			?>
		</div>
	</header>
	...
	<div class="container">
        <div class="row">
             <?php
                include("com_integrantes_lista.php");   
            ?>
        </div>
	</div>
